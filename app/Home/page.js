...
const SliderHome = dynamic(() => import("../components/SliderHome"), {
  ssr: false,
});
const NewShortcode = dynamic(() => import("../components/ShortcodeNew"), {
  ssr: false,
});
...
export default function Home({ ricette }) {
  ...
  useEffect(() => {
    if (videoRef.current) {
      const videoSrc = isMobile
        ? "/img/auriga_mobile_2025.webm"
        : "/img/auriga_desktop_2025.webm";
  ...
  // per aprire il popup dopo 5 secondi che sei in homepage
  // useEffect(() => {
  //   const timer = setTimeout(() => {
  //     setIsModalOpen(true);
  //   }, 1000); // 1000 ms = 1 secondi

  //   return () => clearTimeout(timer); // Pulizia se il componente si smonta prima
  // }, []);
  ...
  return (
    <>
      ...
      <div className="h-[110vh] w-full relative">
        ...
        <div
          id="hero-section"
          className="h-[80vh]  z-[998] w-full absolute bottom-0"
        >
          {!isMobile && (
      ...
      <div className="relative bg-yellowLight">
        ...
        <div
          id="main2"
          className="flex flex-col justify-start items-center relative z-10"
        >
          ...
          <div>
            <Image
              ...
              src={
                isMobile
                  ? "/img/Tonno_Auriga_prodotti_mobile.webp"
                  : "/img/Tonno_Auriga_prodotti.webp"
              }
          ...
          <div className="flex flex-col lg:gap-[20px] items-center -mt-[2%]  lg:-mt-[5%]">
            <Link
              ...
              href="/ProdottiPage"
              className="uppercase text-center fontPrimary bg-yellowDark text-yellowLight rounded-full px-4 py-2 text-base text-wrap lg:text-2xl hover:text-red transition duration-500 ease-in-out"
            >
              Scopri i nostri Prodotti
            </Link>
            <p className="text-center textFontLight text-base md:text-2xl 2xl:text-[2rem]  w-[70vw] lg:w-[55vw] 2xl:w-[45vw] py-2 ">
              Scopri la grande famiglia Auriga: prodotti di prima scelta,
              pescati responsabilmente e confezionati con amore. Esplora la
              nostra gamma e trova il tuo preferito per ogni piatto.
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-col -mt-[5%] md:mt-0  justify-center items-center  text-yellowLight bg-red">
          ...
          <div className="m-0 mb-[2%] p-0 z-[200] flex justify-center flex-col items-center">
            <div className="flex xl:max-w-[1000px] 2xl:max-w-[90%] m-0 p-0 flex-wrap gap-4 mt-[3%] justify-center items-center">
              {(ricette && Array.isArray(ricette)
                ? ricette.slice(0, 6)
                : []
              ).map((ricetta) => (
                <Link
                  title="Scopri la ricetta"
                  href={`${process.env.NEXT_PUBLIC_BASE_URL}/wp/ricetta/${
                    ricetta.slug || ""
                  }`}
                  key={ricetta.slug}
                >
                  <div
                    id="cardOverlay"
                    className="w-[300px] max-w-[500px] 2xl:w-[30vw]"
                  >
                    {/* foto */}
                    <div className="h-[200px] 2xl:h-[30vh] rounded-t-2xl">
                      <Image
                        src={
                          isMobile && ricetta.fotoCopertinaMobile
                            ? ricetta.fotoCopertinaMobile
                            : ricetta.fotoCopertina
                        }
                        width={30}
                        height={30}
                        alt="foto ricetta"
                    ...
                    <div className="bg-yellowLight rounded-b-2xl border-none h-[100px] flex flex-col p-2 sticky z-[100]">
                      ...
                      <p
                        className="text-red ml-1 capitalize text textTroncate"
            ...
            <div className=" mt-[5%] flex items-center justify-center">
              <Link
                title="Esplora le nostre ricette"
                href="/Ricette"
                className="uppercase fontPrimary bg-yellowDark text-yellowLight rounded-full px-4  py-2 text-base lg:text-2xl hover:text-red transition duration-500 ease-in-out"
              >
      ...
      <div className="flex flex-col sticky justify-start items-center  bg-red z-[50] p-[10%] md:p-0  md:pb-[5%] ">
        <h3
          className="text-yellowDark bg-red rounded-lg absolute -mt-4 lg:-mt-10 
