    ...
    <>
      ...
      <div className="relative hidden md:block z-[999]">
        ...
        <div className="w-full px-[10%] absolute hidden md:flex text-sm 2xl:text-base justify-between h-[6vh] z-[999]">
          <Link
            className={`md:pt-[1%] lg:pt-[2%] uppercase font-semibold ${
              activeComponent === "prodotti" ? "text-yellowDark" : ""
            }`}
            href="/ProdottiPage"
          ...
          <Link
            className={`md:pt-[1%] lg:pt-[2%] uppercase font-semibold ${
              activeComponent === "ricette" ? "text-yellowDark" : ""
            }`}
            href="/Ricette"
            title="Scopri le nostre ricette"
          >
            Ricette
          </Link>
          <Link
            className={`md:pt-[1%] lg:pt-[2%] uppercase font-semibold ${
              activeComponent === "educational" ? "text-yellowDark" : ""
            }`}
            href="/Educational"
            title="Scopri di più sul tonno"
          >
            #oralosai
          </Link>
          <Link href="/">
            <Image
              ...
              width={20}
              height={20}
              className="w-[8vw] mt-[5%]"
            />
          </Link>
          <Link
            className={`md:pt-[1%] lg:pt-[2%] uppercase font-semibold ${
              activeComponent === "chisiamo" ? "text-yellowDark" : ""
            }`}
            href="/ChiSiamo"
          ...
          <Link
            className={`md:pt-[1%] lg:pt-[2%] uppercase font-semibold ${
              activeComponent === "contatti" ? "text-yellowDark" : ""
            }`}
            href="/Contatti"
            title="Contattaci"
          >
          ...
          <div className="w-[100px] h-[6vh]">
            <Link
              className={`md:pt-[1%] lg:pt-[2%] flex items-center  uppercase font-semibold ${
                activeComponent === "" ? "text-yellowDark" : ""
              }`}
              href="https://www.tonnoauriga.it/wp/directory/"
              title="Trova il nostro tonno"
            >
              <Image
                alt="logo"
                src="/img/maps.webp"
                width={40}
                height={15}
                className="  object-contain  lg:mt-[10%] 2xl:mt-[20%]"
              />
              <p className="text-[11px] leading-3 flex flex-col gap-0  mt-[10%] 2xl:mt-[20%]">
      ...
      <div className="relative md:hidden z-[998]">
        ...
        >
          <path
            fill="white"
            fillOpacity="1"
            d="M0,250L120,220C240,190,480,160,720,160C960,160,1200,190,1320,220L1440,250L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z"
          ></path>
        </svg>

        <div className=" w-full absolute h-[10vh] flex justify-center">
          <div className="w-[20vw]">
            <Link href="/" title="Tonno Auriga">
              <Image
                alt="logo auriga"
                priority={true}
                quality={80}
                className="object-contain w-[20vw] mt-[10%] "
                width={50}
                height={50}
                src="/img/logo.webp"
              />
          ...
          <button
            aria-label="menu"
            className="z-[999] absolute right-[5%] top-[25%] focus:outline-none"
            onClick={toggleMenu}
          >
            <svg
              className="w-10 h-8"
