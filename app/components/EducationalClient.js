    ...
    <div className="">
      ...
      <div className="flex  flex-col items-center justify-center ">
        <div className="h-[80vh] w-full">
          <Image
            alt="influenzer che mangia una fetta di pane con il tonno"
            src="/img/hero.webp"
            width={300}
            height={300}
        ...
        <div className="flex  items-center justify-center h-[20vh]">
          <h1 className="fontPrimary text-yellowDark text-3xl md:text-5xl lg:text-[5rem] 2xl:text-[7rem]">
            #ORALOSAI
          </h1>
        </div>
      </div>
      ...
      <div className="mt-[3%] flex flex-col gap-[10vh] md:gap-[30vh]">
        ...
        <div className="flex flex-col md:flex-row gap-[25px] md:gap-0">
          ...
          <div className="w-[100%] md:w-[50%]">
            <Image
              width={300}
              height={300}
              alt="foto che chiarische il testo accanto"
        ...
        <div className="flex flex-col md:flex-row gap-[25px] md:gap-0">
          <div className="w-[100%] md:w-[70%]  flex justify-center items-center">
            <CardEducational
              titolo="La scatoletta è sicura come il vetro"
