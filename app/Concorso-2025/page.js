import ConcorsoClient from "../components/ConcorsoClient";
...
export const metadata = {
  ...
  openGraph: {
    title: "Tonno Auriga - Concorso Giungno 2025",
    description:
      "Scopri la storia e la tradizione di Tonno Auriga, leader nella produzione di tonno di alta qualità. Da generazioni, offriamo prodotti genuini e sostenibili dal mare alla tua tavola.",
  ...
  additionalMetaTags: [
    {
      name: "keywords",
      content:
        "tonno, auriga, castiglione, peschereccio, erice, trapani, sicilia, tonno in scatola, concorso, premi ",
    },
    {
      name: "author",
